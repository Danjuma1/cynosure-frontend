      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">Federal High Court · {court?.city}</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <Card className="p-12">
          <EmptyState
            ...
            description="No Federal High Court judges found for this division."
          />
        </Card>
      ) : (
        <div className="grid md:grid-cols-2 gap-4">
          {judges.map((judge, i) => (
            <motion.div key={judge.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.06 }}>
              <button onClick={() => navigate(`/csi/federal/FHC/${courtId}/${judge.id}`)} className="w-full text-left">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {judge.is_chief_judge && (
                        <p className="text-xs text-blue-600 font-medium mt-0.5">Chief Judge</p>
                      )}
                    </div>
